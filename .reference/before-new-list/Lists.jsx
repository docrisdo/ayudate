...
export default function ListsScreen({ lists, selectedList, products, newListName, onNameChange, onCreateList, onSelectList, onUpdateList, onDeleteList, onRestoreList, onAddProduct, onRemoveProduct, onStart, onNavigate, onRead, voiceSupported }) {
  ...
  return (
    <div className="lists-screen">
      ...
      <div className="lists-content">
        ...
        <div className="lists-new-action"><button type="button" className="lists-button" aria-expanded={creating} aria-controls="lists-create-form" onClick={() => setCreating(!creating)}><Icon name="icon-plus" />Nueva lista</button></div>
