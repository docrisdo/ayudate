...
export default function NewList({ products, onNavigate, onSave, onRead, voiceSupported }) {
  ...
  return <div className="lists-screen nl-screen">
    ...
    <main className="nl-content" id="main-content" tabIndex={-1}>
      ...
      <section className="nl-name nl-panel"><label htmlFor="nl-name">Nombre de la lista</label><input id="nl-name" aria-describedby="nl-status" ref={nameRef} value={name} maxLength={80} onChange={event => setName(event.target.value)} placeholder="Ej. Compra semanal" required /></section>
