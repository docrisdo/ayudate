...
export const milkProducts = [
  { id: 13, name: 'Leche entera', brand: 'LALA', price: 32, unit: '1 L', image: '/assets/search-products/leche-lala.png' },
  { id: 14, name: 'Leche entera', brand: 'Santa Clara', price: 33.5, unit: '1 L', image: '/assets/search-products/leche-santa-clara.png' },
  { id: 15, name: 'Leche entera', brand: 'Alpura', price: 31, unit: '1 L', image: '/assets/search-products/leche-alpura.png' },
  { id: 16, name: 'Leche entera en polvo', brand: 'NIDO', price: 89, unit: '720 g', image: '/assets/search-products/leche-nido.png' },
