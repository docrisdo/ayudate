...
export default function AccessibilityProvider({ children }) {
  ...
  return <AccessibilityContext.Provider value={announce}>
    <a className="a11y-skip" href="#contenido-principal" onClick={event => { event.preventDefault(); document.getElementById('contenido-principal')?.focus() }}>Saltar al contenido principal</a>
    {children}
