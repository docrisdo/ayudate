...
export default function Route({ list, products: originalProducts, accessibleRoute = false, pictograms = true, index, onIndex, cart, onFound, onRestore, onNavigate, onRead, voiceSupported }) {
  ...
  const instruction = (accessibleRoute ? 'Ruta accesible: sigue los pasillos principales por las zonas del perímetro y termina en la zona central. Solicita asistencia si encuentras obstáculos. ' : '') + (product
